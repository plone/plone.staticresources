...
ICONS_DIR = "{dir}/../static/components/bootstrap-icons/icons".format(dir=this_dir)
OUTPUT_FILE = "{dir}/../profiles/default/registry/bootstrap_icons.xml".format(
    dir=this_dir
)
...
entry = """
  <record name="plone.staticresources.icon.{icon}">
    ...
    <value key="resource">++plone++static/components/bootstrap-icons/icons/{icon}.svg</value>
  </record>
"""
